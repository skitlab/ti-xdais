...
public class xdais_7_22_00_03
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("xdais_7_22_00_03.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("xdais_7_22_00_03", new Value.Obj("xdais_7_22_00_03", pkgP));
    }
    ...
    void Version$$OBJECTS()
    {
        ...
        po = (Proto.Obj)om.bind("xdais_7_22_00_03.Version.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("xdais_7_22_00_03.Version", new Value.Obj("xdais_7_22_00_03.Version", po));
    ...
    {
        // module Version
        om.bind("xdais_7_22_00_03.Version.MAJOR", 7L);
        om.bind("xdais_7_22_00_03.Version.MINOR", 22L);
        om.bind("xdais_7_22_00_03.Version.PATCH", 00L);
        om.bind("xdais_7_22_00_03.Version.WIDTH", 2L);
    }
    ...
    void Version$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("xdais_7_22_00_03.Version.Module", "xdais_7_22_00_03");
        po.init("xdais_7_22_00_03.Version.Module", om.findStrict("ti.sdoarch.standards.pkg.IVersion.Module", "xdais_7_22_00_03"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("MAJOR", Proto.Elm.newCNum("(xdc_UInt16)"), 7L, "rh");
                po.addFld("MINOR", Proto.Elm.newCNum("(xdc_UInt16)"), 22L, "rh");
                po.addFld("PATCH", Proto.Elm.newCNum("(xdc_UInt16)"), 00L, "rh");
                po.addFld("WIDTH", Proto.Elm.newCNum("(xdc_UInt16)"), 2L, "rh");
        if (isCFG) {
        }//isCFG
                po.addFxn("getString", (Proto.Fxn)om.findStrict("ti.sdoarch.standards.pkg.IVersion$$getString", "xdais_7_22_00_03"), $$UNDEF);
    }
    ...
    void Version$$ROV()
    {
        ...
        vo = (Value.Obj)om.findStrict("xdais_7_22_00_03.Version", "xdais_7_22_00_03");
    }

    void $$SINGLETONS()
    {
        pkgP.init("xdais_7_22_00_03.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "xdais_7_22_00_03"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "xdais_7_22_00_03", Value.DEFAULT, false);
        pkgV.bind("$name", "xdais_7_22_00_03");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "xdais_7_22_00_03.");
        ...
        sb.append("var pkg = xdc.om['xdais_7_22_00_03'];\n");
    ...
    void Version$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.findStrict("xdais_7_22_00_03.Version", "xdais_7_22_00_03");
        po = (Proto.Obj)om.findStrict("xdais_7_22_00_03.Version.Module", "xdais_7_22_00_03");
        vo.init2(po, "xdais_7_22_00_03.Version", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", $$UNDEF);
        vo.bind("$package", om.findStrict("xdais_7_22_00_03", "xdais_7_22_00_03"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
        icfgs.clear();
        ...
        ((Value.Arr)om.findStrict("$modules", "xdais_7_22_00_03")).add(vo);
        vo.bind("$$instflag", 0);
        vo.bind("$$iobjflag", 0);
        vo.bind("$$sizeflag", 1);
        vo.bind("$$dlgflag", 0);
        ...
        vo.bind("$$fxntab", Global.newArray("xdais_7_22_00_03_Version_Module__startupDone__E"));
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("xdais_7_22_00_03.Version", "xdais_7_22_00_03"));
        Global.callFxn("init", pkgV);
        ((Value.Obj)om.getv("xdais_7_22_00_03.Version")).bless();
        ((Value.Arr)om.findStrict("$packages", "xdais_7_22_00_03")).add(pkgV);
    }
