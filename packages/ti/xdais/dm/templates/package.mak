...
override PKGDIR = ti/xdais/dm/templates
...
package/%.xdc.inc package/%_ti.xdais.dm.templates.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package ti.xdais.dm.templates" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js ti.xdais.dm.templates $@
...
.PHONY: release,ti_xdais_dm_templates
ti_xdais_dm_templates.tar: package/package.bld.xml
ti_xdais_dm_templates.tar: package/package.ext.xml
ti_xdais_dm_templates.tar: package/package.rel.dot
ti_xdais_dm_templates.tar: package/build.cfg
ti_xdais_dm_templates.tar: package/package.xdc.inc
ti_xdais_dm_templates.tar: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/ti_xdais_dm_templates.tar.dep
endif
package/rel/ti_xdais_dm_templates/ti/xdais/dm/templates/package/package.rel.xml:

ti_xdais_dm_templates.tar: package/rel/ti_xdais_dm_templates.xdc.inc package/rel/ti_xdais_dm_templates/ti/xdais/dm/templates/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/ti_xdais_dm_templates.xdc.inc,package/rel/ti_xdais_dm_templates.tar.dep)


release release,ti_xdais_dm_templates: all ti_xdais_dm_templates.tar
clean:: .clean
	-$(RM) ti_xdais_dm_templates.tar
	-$(RM) package/rel/ti_xdais_dm_templates.xdc.inc
	-$(RM) package/rel/ti_xdais_dm_templates.tar.dep
